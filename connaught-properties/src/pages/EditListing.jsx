...
function EditListing() {
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      // Get the params from the url (the id)
      const docRef = doc(db, "listings", params.listingId);
      const docSnap = await getDoc(docRef);
      if (docSnap.exists()) {
        // if the doc exists, set the listing to the data
        setListing(docSnap.data());
        // Get/Set form data
        setFormData({
          // Spread the data from the docSnap (and add the address; as is saved as location in db)
          ...docSnap.data(),
  ...
  const onSubmit = async (e) => {
    ...
    */
    ...
    // Update listing instead of Adding new listing
    // Save to database
    const docRef = doc(db, "listings", params.listingId); // Get the docRef
    await updateDoc(docRef, formDataCopy); // Update the doc
  ...
  return (
    <div className="profile">
      <header>
        <p className="pageHeader text-center">Edit Listing</p>
      </header>
      <main>
